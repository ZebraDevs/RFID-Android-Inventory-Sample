...
class RFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    private int initialPower = MAX_POWER;
    ...
    private class CreateInstanceTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            readers = new Readers(context, ENUM_TRANSPORT.SERVICE_USB); //changed from USB to all for MC3300
            try {
    ...
    private void ConfigureReader() {
        ...
        if (reader.isConnected()) {
            ...
            try {
                ...
                config.setTransmitPowerIndex(initialPower * 10);//changed from max_power
                Log.d(TAG, "Power set to " + initialPower + "(x10)");
    ...
    public synchronized void setPower(int power) throws InvalidUsageException, OperationFailureException {
